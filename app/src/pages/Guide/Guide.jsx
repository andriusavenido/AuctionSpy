const Guide = () => {
    return ( 
    <div className="guide">
        <p>Auction Spy is an engaging online chat-based game that combines the thrill of deduction with the excitement of auctions. Inspired by the popular tabletop game SpyFall, Auction Spy challenges players to identify the infiltrator among them.
...
Auction Spy offers a unique blend of strategy, social interaction, and deduction, making it a thrilling experience for players who enjoy mystery and intrigue.</p>
    </div> );
}
